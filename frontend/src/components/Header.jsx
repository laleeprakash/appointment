...
function Header(){
  return(
    <div className="flex flex-row md:flex-row flex-wrap bg-primary -lg px-6 md:px-10 lg:px-20">
                        {/*--------------------------left side------------------------------- */}
        ...
        <div className="flex flex-col md:flex-row items-center gap-3 text-white text-sm font-light">
          ...
          <p>Simple browse through our extensive list of trusted Doctors,<br className="hidden sm:block"/> schedule your appointment hassle-free.
          </p>
        </div>
